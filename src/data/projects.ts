...
export const projects: Project[] = [
  {
    ...
    tech: ["React", "TypeScript", "Node.js", "Express", "Twilio"],
    category: "Full-Stack",
    image: "/couriercall.png",
    link: "https://www.couriercall.site/",
    github: "https://github.com/Librapraise/Courier-Call-Masking-System.git",
    featured: true
  },
  {
    title: "PlowPath",
    description: "Commercial snow plow dispatch and live tracking platform. Optimize route dispatches, track plow fleets in real time with high-precision telemetry, and manage operations control.",
    tech: ["React", "TypeScript", "Tailwind CSS", "Mapbox", "Node.js"],
    category: "Full-Stack",
    image: "/plowpath.png",
    link: "https://plowpath.ca/",
    github: "https://github.com/Librapraise/PlowPath.git",
    featured: true
  },
  {
  ...
  },
  {
    ...
    category: "Full-Stack",
    image: "/mindai.png",
    link: "https://mind-journal-ten.vercel.app/",
